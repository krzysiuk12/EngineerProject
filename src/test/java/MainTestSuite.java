 ...
 */
@RunWith(Suite.class)
@Suite.SuiteClasses({GoogleApiPathBuildersTest.class, ValidationToolsTest.class, CodeGeneratorServiceTest.class, FreeGeoServiceTest.class, GoogleDirectionsServiceTest.class, GoogleGeocodingServiceTest.class, EventsServiceTest.class, LocationManagementServiceTest.class, SecurityProfilesManagementServiceTest.class, SessionManagementServiceTest.class, TripsManagementServiceTest.class, UserManagementServiceTest.class})
